...
import { BalanceMsg } from "../../helpers";
...
export const Unstake = ({token}: UnstakeFormProps) => {
    ...
    ? parseFloat(formatUnits(balance, 18)) : 0
        ...
        <>
            <div className={classes.contentContainer}>
                ...
                >
                    ...
                    {isMining ? <CircularProgress size={24} /> : `Unstake all ${name}`}
                </Button>
            </div>
            <Snackbar
            ...
            >
            <Alert onClick={handleCloseSnack} severity="success">
