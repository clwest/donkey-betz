...
### Root Cause:
The **ConsciousnessBridge** (`backend/spiders/consciousness.py`) is:
...
Edit `backend/spiders/consciousness.py` around line 146:
```python
# FIND THIS:
...
2. **backend/spiders/consciousness_fix.py** - Working fix example
3. **backend/spiders/consciousness.py** - Needs fixing (line 146+)
