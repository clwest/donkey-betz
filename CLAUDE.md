...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); 151 rows in Agent table. |
| **Spiders** | 80 spiders across 41 categories (80 working, 0 placeholder) |
| **Services** | 112 `*Service` classes across 332 files in core/services/ |
| **Celery Tasks** | 398 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 78 enabled + 0 disabled = 78 PeriodicTask rows |
| **PA Tools** | 103 tool schemas + 168 registered handlers; 8 enrichment services |
| **Database Models** | 581 concrete models across 23 apps |
