...
| **Services** | 112 `*Service` classes across 337 files in core/services/ |
| **Celery Tasks** | 400 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 80 enabled + 0 disabled = 80 PeriodicTask rows |
| **PA Tools** | 104 tool schemas + 169 registered handlers; 8 enrichment services |
