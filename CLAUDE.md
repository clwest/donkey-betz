...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); DB persona rows are tracked separately. |
...
|-----------|-------|---------|
| **Agents (AGENT_MAP)** | 83 | 83 AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); DB persona rows are tracked separately; provenance-tracked and workspace-aware subsets documented elsewhere |
...
| **Advisors** | 30 | 16 named figures (Warren Buffett, Cathie Wood, Ray Dalio, Sam Altman, Elon Musk, Gary Vaynerchuk, MrBeast, Chris Voss, Billy Beane, Haralabos Voulgaris, Dr. Peter Attia, Grant Cardone, Kevin Mitnick, Sal Khan, Tim Cook, Andrew Ng) + 14 domain specialists. See [`docs/ADVISOR_AUDIT.md`](docs/ADVISOR_AUDIT.md). |
