...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); 155 rows in Agent table. |
| **Spiders** | 80 spiders across 41 categories (80 working, 0 placeholder) |
| **Services** | 112 `*Service` classes across 338 files in core/services/ |
| **Celery Tasks** | 403 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 82 enabled + 0 disabled = 82 PeriodicTask rows |
| **PA Tools** | 106 tool schemas + 171 registered handlers; 8 enrichment services |
| **Database Models** | 586 concrete models across 23 apps |
