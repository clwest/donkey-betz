...
| **Services** | 112 `*Service` classes across 348 files in core/services/ |
| **Celery Tasks** | 408 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 81 enabled + 6 disabled = 87 PeriodicTask rows |
| **PA Tools** | 108 tool schemas + 173 registered handlers; 8 enrichment services |
| **Database Models** | 588 concrete models across 23 apps |
