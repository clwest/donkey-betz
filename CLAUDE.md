...
| **Services** | 112 `*Service` classes across 336 files in core/services/ |
| **Celery Tasks** | 400 user-defined Celery tasks (excludes celery.* internals) |
...
| **Database Models** | 584 concrete models across 23 apps |
