...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (73 enabled, 8 rerouted, 2 blocked); DB persona rows are tracked separately. |
...
|-----------|-------|---------|
| **Agents (AGENT_MAP)** | 83 | 83 AGENT_MAP (73 enabled, 8 rerouted, 2 blocked); DB persona rows are tracked separately; provenance-tracked and workspace-aware subsets documented elsewhere |
