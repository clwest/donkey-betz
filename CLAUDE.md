...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); 148 rows in Agent table. |
...
| **Celery Tasks** | 397 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 45 enabled + 0 disabled = 45 PeriodicTask rows |
| **PA Tools** | 101 tool schemas + 166 registered handlers; 8 enrichment services |
| **Database Models** | 574 concrete models across 23 apps |
