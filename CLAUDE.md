...
|---|---|
| **Agents** | 83 agents in AGENT_MAP; DB persona rows are tracked separately. |
...
|-----------|-------|---------|
| **Agents (AGENT_MAP)** | 83 | 83 AGENT_MAP; DB persona rows are tracked separately; provenance-tracked and workspace-aware subsets documented elsewhere |
