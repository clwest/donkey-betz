...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); 87 rows in Agent table. |
| **Spiders** | 80 spiders across 41 categories (80 working, 0 placeholder) |
| **Services** | 112 `*Service` classes across 345 files in core/services/ |
| **Celery Tasks** | 407 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 80 enabled + 6 disabled = 86 PeriodicTask rows |
| **PA Tools** | 108 tool schemas + 173 registered handlers; 8 enrichment services |
| **Database Models** | 587 concrete models across 23 apps |
