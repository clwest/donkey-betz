...
| **Services** | 112 `*Service` classes across 355 files in core/services/ |
| **Celery Tasks** | 412 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 90 enabled + 5 disabled = 95 PeriodicTask rows |
| **PA Tools** | 109 tool schemas + 152 registered handlers; 8 enrichment services |
