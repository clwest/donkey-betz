...
|---|---|
| **Agents** | 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); 89 rows in Agent table. |
| **Spiders** | 80 spiders across 41 categories (80 working, 0 placeholder) |
| **Services** | 112 `*Service` classes across 351 files in core/services/ |
| **Celery Tasks** | 409 user-defined Celery tasks (excludes celery.* internals) |
| **Beat Schedule** | 88 enabled + 4 disabled = 92 PeriodicTask rows |
