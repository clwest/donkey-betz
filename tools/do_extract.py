...
def main():
    ...
    for domain in sorted(all_domains):
        ...
        parts = [
            ...
            f'import json  # noqa: F401\n'
            f'import logging  # noqa: F401\n'
            f'import os  # noqa: F401\n'
            f'import time  # noqa: F401\n'
            f'from datetime import datetime, timedelta  # noqa: F401\n'
            f'from typing import Any, Dict, List, Optional, Tuple, Union  # noqa: F401\n'
            f'\n'
            f'from celery.exceptions import SoftTimeLimitExceeded  # noqa: F401\n'
            f'from django.db import transaction  # noqa: F401\n'
            f'from django.db.models import F, Count, Q  # noqa: F401\n'
            f'from django.utils import timezone  # noqa: F401\n'
            f'\n'
            f'from core.api_helpers import smart_truncate  # noqa: F401\n'
            f'\n'
