...
def start_interview_api(request):
    ...
    try:
        ...
        # Start interview
        result = async_to_sync(personal_assistant_interviewer.start_interview)(
            user_id=user_id,
...
def interview_status_api(request):
    ...
    try:
        user_id = str(request.user.id)
        status_data = async_to_sync(personal_assistant_interviewer.get_interview_status)(user_id)
...
def user_context_api(request):
    ...
    try:
        ...
        context = async_to_sync(profile_context_service.get_user_context)(user_id, context_type)
...
def personalized_greeting_api(request):
    ...
    try:
        user_id = str(request.user.id)
        greeting = async_to_sync(profile_context_service.get_personalized_greeting)(user_id)
...
def profile_summary_api(request):
    ...
    try:
        user_id = str(request.user.id)
        summary = async_to_sync(profile_context_service.get_context_summary)(user_id)
...
def update_user_context_api(request):
    ...
    try:
        ...
        success = async_to_sync(profile_context_service.update_user_context)(user_id, updates)
