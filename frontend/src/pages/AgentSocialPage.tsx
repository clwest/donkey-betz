  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <Breadcrumb currentPage="Agent Dreams" />
          <p className="text-sm text-gray-400 mt-1">
            Creative dreams and expressions from agents
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            <RefreshCw size={16} className={loadingDreams ? 'animate-spin' : ''} />
            Refresh
          </button>
        </div>
      </div>
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="flex items-center justify-between border-b border-dark-border pb-2">
            ...
            <div className="relative">
              <select
                value={dreamsTimeRange}
                onChange={(e) => handleDreamsTimeRangeChange(e.target.value as TimeRange)}
