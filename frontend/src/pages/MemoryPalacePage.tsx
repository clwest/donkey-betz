...
const MEMORY_TYPE_CONFIG: Record<string, { icon: typeof Brain; color: string; bgColor: string }> = {
  interaction: { icon: MessageSquare, color: 'text-blue-600', bgColor: 'bg-blue-100' },
  learning: { icon: Lightbulb, color: 'text-yellow-600', bgColor: 'bg-yellow-100' },
  skill: { icon: Star, color: 'text-purple-600', bgColor: 'bg-purple-100' },
  knowledge: { icon: BookOpen, color: 'text-green-600', bgColor: 'bg-green-100' },
  experience: { icon: Brain, color: 'text-pink-600', bgColor: 'bg-pink-100' },
  default: { icon: Brain, color: 'text-gray-600', bgColor: 'bg-gray-100' },
}
      ...
      {!selectedAgent && overviewData?.overview && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg p-4 border shadow-sm">
            ...
            <div className="text-sm text-gray-500">Agents with Memories</div>
          </div>
          <div className="bg-white rounded-lg p-4 border shadow-sm">
            ...
            <div className="max-h-[600px] overflow-y-auto">
              {!selectedAgent ? (
                ...
                loadingOverview ? (
                  ...
                  <div className="p-4 text-center text-gray-500">No agents with memories</div>
                ) : (
                  ...
                  <>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-gray-900">All Memories</div>
                    ...
                    {roomsData?.rooms?.map((room) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            'w-full p-4 text-left hover:bg-gray-50 border-b last:border-b-0 transition-colors',
...
function MemoryDetailCard({
  ...
  return (
    <div className="space-y-4">
      {/* Main Card */}
      <div className={cn('bg-white rounded-lg border shadow-sm border-l-4', valenceColor)}>
        <div className="p-6">
          {/* Header */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t">
            ...
            <div>
              ...
              <div className="text-lg font-semibold capitalize">{memory.valence}</div>
            </div>
            <div>
            ...
            {memory.connected_memories.map((connected) => {
              ...
              return (
                <button
                  ...
                  className="w-full p-3 text-left hover:bg-gray-50 rounded-lg border transition-colors flex items-center gap-3"
                >
                  <div className={cn('p-2 rounded-lg', connConfig.bgColor)}>
                    <ConnIcon className={cn('h-4 w-4', connConfig.color)} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="font-medium text-gray-900 truncate">{connected.title}</div>
