              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    } rounded-md placeholder-gray-400 bg-card/50 text-foreground focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm disabled:opacity-50`}
