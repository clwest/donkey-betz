        ...
        <div className="bg-white/10 backdrop-blur-md py-8 px-4 shadow-2xl sm:rounded-lg sm:px-10 border border-white/20">
          {!success ? (
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-600 rounded-md placeholder-gray-400 bg-card/50 text-foreground focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-foreground bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50"
                >
            ...
            <div className="text-center">
              ...
              {resetInfo && (
                <div className="mt-4 p-4 bg-card/50 rounded-lg border border-gray-700">
                  <p className="text-xs text-muted-foreground mb-2">Development mode - Reset info:</p>
                  <div className="text-xs text-muted-foreground text-left font-mono">
