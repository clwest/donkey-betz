        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-foreground px-4 py-2 rounded-lg transition-colors flex items-center gap-2"
            >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-muted-foreground text-sm">Current Title</label>
                  <p className="text-foreground font-medium">{profile?.current_title || 'Not provided'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-muted-foreground text-sm">Desired Salary</label>
                  <p className="text-foreground font-medium flex items-center gap-1">
                ...
                <div>
                  <label className="text-muted-foreground text-sm">Remote Preference</label>
                  <p className="text-foreground font-medium">
                    {getRemotePreferenceDisplay(profile?.remote_preference || '')}
                  </p>
                </div>
                <div>
                  <label className="text-muted-foreground text-sm">Willing to Relocate</label>
                  <p className="text-foreground font-medium">
                  ...
                  {profile.skills.slice(0, 8).map((skill, index) => (
                    <div key={index} className="bg-gray-700 rounded-lg p-3">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="bg-blue-600 text-foreground text-xs px-2 py-1 rounded">
                          {skill.proficiency}
                        </div>
                      </div>
                    </div>
                ...
                {profile?.portfolio_url && (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-foreground font-medium text-sm">Portfolio</p>
                        <p className="text-muted-foreground text-xs">View Work</p>
                      </div>
                    </div>
                  </a>
                )}
          ...
          <div className="space-y-6">
              ...
              {analytics ? (
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-foreground font-semibold">{analytics.total_applications}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Success Rate</span>
                    <span className="text-green-500 font-semibold">{analytics.success_rate.toFixed(1)}%</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-blue-500 font-semibold">{analytics.successful_applications}</span>
                  </div>
                </div>
              ) : (
              ...
              {completeness && (
                <div className="space-y-4">
                  ...
                  {completeness.missing_fields.length > 0 && (
                    <div>
                      <h4 className="text-foreground font-medium mb-2">Still Needed:</h4>
                      <div className="space-y-2">
                        {completeness.missing_fields.slice(0, 3).map((field, index) => (
                          <div key={index} className="flex items-center gap-2">
                            ...
                            {field.priority === 'high' && (
                              <span className="text-xs bg-red-600 text-foreground px-1 rounded">
                                High
                              </span>
                            )}
                          </div>
                  ...
                  {completeness.suggestions.length > 0 && (
                    <div>
                      <h4 className="text-foreground font-medium mb-2">Recommendations:</h4>
            ...
            <div className="bg-card rounded-lg p-6">
              ...
              <div className="space-y-3">
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-foreground px-4 py-2 rounded-lg transition-colors text-sm">
                  Update Skills
                </button>
                <button className="w-full bg-green-600 hover:bg-green-700 text-foreground px-4 py-2 rounded-lg transition-colors text-sm">
                  Upload New Resume
                </button>
                <button className="w-full bg-purple-600 hover:bg-purple-700 text-foreground px-4 py-2 rounded-lg transition-colors text-sm">
                  Find Jobs
                </button>
              </div>
            </div>
