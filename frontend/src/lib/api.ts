...
export const assistantApi = {
  ...
  paChat: (message: string, options?: { context?: Record<string, unknown>; generate_audio?: boolean; conversation_id?: string; source?: string; platform?: string; workspace_id?: string }) =>
