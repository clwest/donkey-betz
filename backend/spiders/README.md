...
python backend/spiders/deploy_spider_army.py

# Deploy specific cluster only
python backend/spiders/deploy_spider_army.py --cluster alpha

# Dry run to test configuration
python backend/spiders/deploy_spider_army.py --dry-run

# Deploy with dashboard
python backend/spiders/deploy_spider_army.py --dashboard
```
...
python backend/spiders/spider_dashboard.py
```
...
```bash
cd backend/spiders/donkeybetz_spiders
