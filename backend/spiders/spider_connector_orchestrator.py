    ...
    def _initialize_agent_configurations(self):
        ...
        agent_mappings = {
            ...
            "zero_capital_income_generator": {
                ...
                "class_path": "backend.agents.zero_capital_income_generator.ZeroCapitalIncomeGenerator",
        ...
        for agent_id in additional_agents:
            self.agent_configs[agent_id] = AgentConnectionConfig(
                ...
                agent_class_path=f"backend.agents.{agent_id}.{agent_id.title().replace('_', '')}",
