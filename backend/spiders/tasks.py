...
@shared_task(name='backend.spiders.tasks.deploy_spider_batch')
...
@shared_task(name='backend.spiders.tasks.activate_spider_wave')
...
@shared_task(name='backend.spiders.tasks.spider_heartbeat')
...
@shared_task(name='backend.spiders.tasks.collect_spider_data')
...
@shared_task(name='backend.spiders.tasks.deploy_full_army')
...
@shared_task(name='backend.spiders.tasks.clean_inactive_spiders')
...
@shared_task(name='backend.spiders.tasks.quick_deploy')
