...
from core.views_unified_intelligence import unified_intelligence_dashboard, get_unified_intelligence_data
...
def run_agent_execution(agent_id, task_data, project):
    """Execute agent synchronously and return results"""
    try:
        executor = ConcreteAgentExecutor()
