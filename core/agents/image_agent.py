...
def analyze_image_prompt_with_ml(prompt_data: dict) -> dict:
    """Analyze image prompts using ML models (Text) for style/quality enhancement."""
    try:
        ...
        return {
            ...
            'style_analysis': result.prediction if hasattr(result, 'prediction') else None,
        }
    except Exception as e:
        logger.warning(f"ML image prompt analysis failed: {e}")
