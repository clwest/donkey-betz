  ...
  - Include timeline estimates where possible"""
    ...
    def _generate_content(
        ...
        try:
            ...
            # GPT-5.2 uses max_completion_tokens (NOT max_tokens) and NO temperature.
            response = client.chat.completions.create(
                ...
                max_completion_tokens=8000,  # Higher than old 4000 — GPT-5.2 needs room for reasoning + output
