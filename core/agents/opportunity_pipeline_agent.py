...
def analyze_pipeline_with_ml(opportunity_data: dict) -> dict:
    """Analyze opportunity pipeline data using ML models (Text)."""
    try:
        ...
        return {
            ...
            'pipeline_optimization': result.prediction if hasattr(result, 'prediction') else None,
        }
    except Exception as e:
        logger.warning(f"ML pipeline analysis failed: {e}")
