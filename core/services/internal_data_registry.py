...
INTERNAL_DATA_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    'spider_data': {
        ...
        'query_examples': [
            ...
            "SpiderData.objects.filter(data_type='tech', relevance_score__gte=70)",
        ],
        'key_fields': [
            ('id', 'UUID', 'Data record ID'),
            ('spider_name', 'str', 'Which spider collected this'),
            ('source_url', 'str', 'Original source URL'),
            ('data_type', 'str', 'Content type/category'),
            ('raw_data', 'JSON', 'Raw collected data (items, metadata)'),
            ('embedding_text', 'text', 'Text for semantic search'),
            ('relevance_score', 'int', 'Relevance 0-100'),
