    ...
    # ── Session 1079: Content Gateway ─────────────────────────────────────────
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "dry_run": {"type": "boolean", "description": "For bulk_archive / bulk_archive_published / generate_newsletter: preview without executing (DEFAULT: true). Set dry_run=false AND confirm=true to execute (Session 1228 PR-A belt-and-suspenders). S2944 Ledger #38 batch 3: bulk_archive + generate_newsletter dry_run responses now return `no_writes:true` + `would_action` envelope for pattern-alignment with blog_tool / feedback_tool (adds to S2943 bulk_archive_published alignment)."},
