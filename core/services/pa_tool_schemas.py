    ...
    # ── Session 1077: Focused deliverable_tool (split from content_tool) ────────
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "has_initiative": {"type": "boolean", "description": "For list: true returns only deliverables that have ANY initiative attached; false returns only deliverables with no initiative. Use with `agent` to answer 'which of agent X's deliverables are attached to initiatives' (the canonical cross-query gap closed Session 1226)."},
