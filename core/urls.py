...
from core.views_image import (
    ...
    control_sketch, control_structure, execute_workflow_step, unified_gallery, session_gallery, list_sessions, get_project_sessions, get_session_analytics, delete_session, unified_batch_download, unified_toggle_favorite,
