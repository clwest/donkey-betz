...
"""
Migration 0183 accidentally deleted body system tables that 0181 created.
This migration restores them to match the model definitions in:
- core/models_brain.py (BrainPulse, CognitiveChannel, CognitiveStatus)
- core/models_skin.py (SkinPulse, SkinStatus)
- core/models_nervous.py (NervousPulse, NervousStatus, WebSocketConnectionLog)

Session 807: This is the corrective migration after the erroneous 0183 delete.
"""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(blank=True, choices=[
                    ('openai', 'OpenAI'),
                    ('anthropic', 'Anthropic'),
                ...
                ('model_name', models.CharField(blank=True, help_text='Specific model (e.g., gpt-5-mini)', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Skin Statuses',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Nervous Statuses',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['-recorded_at'], name='core_brain__recorde_idx'),
        ),
        migrations.AddIndex(
            model_name='brainpulse',
            index=models.Index(fields=['overall_status', '-recorded_at'], name='core_brain__status_idx'),
        ),
    ]
