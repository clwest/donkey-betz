...
### 1. Spider Registry (`ai_core/spiders/spider_registry.py`)
...
### 2. Spider Orchestrator (`ai_core/spiders/spider_orchestrator.py`)
...
- `ai_core/spiders/toptal_spider.py`
- `ai_core/spiders/guru_spider.py`
- `ai_core/spiders/flexjobs_spider.py`
- `ai_core/spiders/remoteok_spider.py`
- `ai_core/spiders/peopleperhour_spider.py`
...
3. **The mock data system:** `ai_core/spiders/spider_mock_data.py`
