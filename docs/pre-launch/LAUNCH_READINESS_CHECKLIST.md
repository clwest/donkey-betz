...
> **Current canon:** [`../archive/superseded-2026-05/pre-launch/LAUNCH_READINESS_CHECKLIST.md`](../archive/superseded-2026-05/pre-launch/LAUNCH_READINESS_CHECKLIST.md) — read this instead.
