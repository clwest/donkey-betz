...
Six intelligence services inject context before the LLM generates analysis. Each intent maps to specific services:
...
**Enrichment caps:** Each section is truncated (300-600 chars) to control token usage.
