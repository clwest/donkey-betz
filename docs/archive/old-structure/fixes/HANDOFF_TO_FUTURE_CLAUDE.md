...
**File**: `ai_core/intelligence/proposal_manager.py:719-836`
...
**File**: `ai_core/agents/concrete_executor.py:95-187`
...
**File**: `ai_core/spiders/consciousness.py:460-600`
...
### Critical Files:
1. **`ai_core/intelligence/proposal_manager.py`** - Self-modification logic
2. **`ai_core/agents/concrete_executor.py`** - Agent execution with retry
3. **`core/command_center_ai.py`** - WebSocket handler & commands
4. **`ai_core/spiders/consciousness.py`** - Dynamic consciousness
