...
|-------|--------|-----------|----------------|---------------|---------------|--------------|---------------|
| **1400** | Revenue / Outreach / Engagement | `pa-34d43795e1b24bd3` (S1400 kickoff) | `docs/research/domains/revenue/1400_revenue_domain_scoping.md` (v2, `status: active`, Chris-locked D21+D23-D29 across 3 rounds) | **S1401 queued next** (Category A — Opportunity Discovery + Scoring) | 2026-07-01 (S1400 open commit) | Inherits 15 findings from S1273 §3.32 + §4.9 + S1274 §2.4 + §3.7 + §5.10 + §9.6 + §14 finding #36; S1399 F1/F2/F3/F4 methodology; overlaps 7 arcs (Group 1300 closed; Employee OS 1200s; Groups 1500/1600/1700 not-started; Group 1300 Cat G delegated; post-1400 design-prep) | S1401 Child A audit per playbook §11.2 20-section template + §13 6-parallel-Explore sweep answering §12.1 Category A questions |
