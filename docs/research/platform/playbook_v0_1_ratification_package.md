...
> **Session 2727 correction note (2026-07-08 UTC):** This document references a Playbook rule count of **165** in §1.2, §2.3, §2.10, §5.2, §5.3, §8, and §6 Step 1. Session 2727 forensic reconciliation established the canonical rule count as **190** — per `docs/research/platform/platform_constitutional_transition_review.md` §"Rule Inventory Reconciliation — Complete" and commit `d24f738e` (the assembled `docs/ENGINEERING_PLAYBOOK.md`). The 165 figure was propagated from Session 2716 self-summary (claimed 8+29=37 for Ch 0+1 but authored 9+48=57) and Session 2720 self-summary (claimed 51 for Ch 10 but authored 55), plus Session 2723's documented split of PLAYBOOK-1.4.5 into 1.4.5+1.4.5a (+1). Chapters 2/3/4/5/6/7/8/9 counts are correct. This correction is treated as a correction to derived summaries; no rule text, evidence citation, statement classification, or SIGN verdict recorded in this document is changed. Historical claims of 165 are preserved in place as a record of what Session 2726 stated. All downstream references — including Rigby SIGN Sessions 2722/2724/2725 that verified 70/165 rules — inherit the same reconciliation: the 70 verified rules stand; the 190 canonical population means 120 rules remain unaudited by Rigby, of which 25 are the delta previously invisible under the 165 baseline. An expanded SIGN pass on the 25 previously-uncounted rules is a Session Owner-directed follow-on before v0.1 ratification proceeds.
