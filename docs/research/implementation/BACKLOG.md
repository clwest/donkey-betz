...
|---|---|---|---|---|---|---|---|---|---|
| `IB-Q1-BOOT-01` | IOS §D3 + Appendix C | queue_construction | Author `ADR-0001-establish-adr-corpus.md` (recursive bootstrap ADR that installs the ADR corpus) | platform | NEEDS_ADR | NONE | TRIAGED | RATIFIED (band) | `docs/adr/` (new dir), `docs/adr/ADR-0001-establish-adr-corpus.md` (new file), IOS §2.5 coupling |
