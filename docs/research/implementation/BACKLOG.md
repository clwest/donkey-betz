...
|---|---|---|---|---|---|---|---|---|---|
| `IB-Q1-BOOT-01` | IOS §D3 + Appendix C | queue_construction | Author `ADR-0001-establish-adr-corpus.md` (recursive bootstrap ADR that installs the ADR corpus) | platform | NEEDS_ADR | SPEC_COMPLETE | IN_ARC | RATIFIED (band) | `docs/adr/` (new dir, created 2026-07-06), `docs/adr/ADR-0001-establish-adr-corpus.md` (new file, authored 2026-07-06). `arc_ref: I-0100`; `adr_ref: ADR-0001` (pending PR merge). Row flips `IN_ARC → SHIPPED` at P0 prep PR merge per §4.5. |
