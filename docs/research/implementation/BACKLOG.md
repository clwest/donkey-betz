...
| intake_id | source_ref | source_type | title | affected_domains | risk_class | design_state | status | chris_gate | affected_surfaces |
|---|---|---|---|---|---|---|---|---|---|
| `IB-2199-T0-01` | 2199 §1 | xx99_followon_T0 | Ratify RAG corpus substrate maturity gradient (spec-complete/execution-pending) | rag,memory | NEEDS_ADR | SPEC_COMPLETE | IN_ARC (I-0200) — flipped `TRIAGED → IN_ARC (I-0200)` at P1 severability determination close 2026-07-07 per Chris "Agree All" ratification of SEVERABLE outcome. Stage 2 authoring constraints locked: PROVISIONAL ADR marker; explicit BOR-01-post-ratification clause; T-slot execution PRs named as post-arc; no runtime enforcement claims; Stage 5 = documentation cross-check only. Stage 2 opens on separate Chris directive. | RATIFIED (band + P1 SEVERABLE 2026-07-07) | `docs/adr/`, RAG substrate |
