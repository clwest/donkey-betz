...
**Generated:** 2026-04-29T05:41:54+00:00
...
| 10875 | `aggregate_spider_signals` | `aggregate_spider_signals` |
| 10879 | `trigger_signal_driven_conversation` | `trigger_signal_driven_conversation` |
| 10883 | `process_pending_auto_topics` | `process_pending_auto_topics` |
| 10887 | `cleanup_expired_signals` | `cleanup_expired_signals` |
...
| Line | Function | Registered name |
| ---: | --- | --- |
| 4845 | `run_blockchain_security_monitor` | `autonomous.blockchain_security_monitor` |

#### `autonomous_studio.*` — 1 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 4358 | `generate_content_for_channel` | `autonomous_studio.generate_content` |

#### `content_studio.*` — 2 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 9241 | `score_episode_voice` | `content_studio.score_episode_voice` |
| 9245 | `backfill_voice_scores` | `content_studio.backfill_voice_scores` |

#### `core.*` — 2 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 12386 | `rag_retrieval_canary` | `core.rag_retrieval_canary` |
| 12392 | `check_learning_loop_slo` | `core.check_learning_loop_slo` |

#### `learning_loop.*` — 2 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 4346 | `track_prediction_outcomes` | `learning_loop.track_prediction_outcomes` |
| 4350 | `calculate_agent_accuracy` | `learning_loop.calculate_agent_accuracy` |

#### `narrative_drift.*` — 3 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 4621 | `run_narrative_drift_cycle` | `narrative_drift.run_detector_cycle` |
| 4625 | `update_narrative_statuses` | `narrative_drift.update_narrative_statuses` |
| 4693 | `trigger_content_from_narrative_shift` | `narrative_drift.trigger_content_from_shift` |

#### `roi_metrics.*` — 4 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 4717 | `record_opportunity_view` | `roi_metrics.record_opportunity_view` |
| 4744 | `record_opportunity_click` | `roi_metrics.record_opportunity_click` |
| 4774 | `record_opportunity_application` | `roi_metrics.record_opportunity_application` |
| 4804 | `record_revenue_event` | `roi_metrics.record_revenue` |

#### `triggers.*` — 2 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 4853 | `process_trigger_events` | `triggers.process_trigger_events` |
| 4997 | `create_default_triggers` | `triggers.create_default_triggers` |

#### `unified_pipeline.*` — 1 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 4697 | `unified_pipeline_health_check` | `unified_pipeline.health_check` |

#### `workspace.*` — 1 task(s)

| Line | Function | Registered name |
| ---: | --- | --- |
| 9249 | `workspace_autopilot_tick` | `workspace.autopilot_tick` |
