...
```
ENCRYPTION_KEY="_SPXXvgWfpgjZ0gFGszQZxfhd0qOzyHXN3hef6EYpMA="
ENCRYPTION_KEY_BACKUP="vwGBDy1PAfyquCH58GsmQN8cZmVszCMnqrdk1_VltBw="
```
...
- **Code:**
```env
STRIPE_SECRET_KEY="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"
...
REDDIT_PASSWORD="Crypto$donkey2025"
```
