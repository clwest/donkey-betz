...
> **⚠ Historical snapshot — do not cite as current.** The table below is a Session 1142 snapshot retained for context. Authoritative counts live in [`PLATFORM_INVENTORY.md`](/docs/PLATFORM_INVENTORY.md) (system counts) and [`docs/INDEX.md`](/docs/INDEX.md) (doc corpus counts) per `DOC_LIFECYCLE.md` §2c.
...
| **PA Tools** | **110 schemas / 174 handlers** | 6 gateway tools, 8 enrichment services; Session 1250 PR 7 added `rigby_work_item` (Rigby internal work-queue review) |
