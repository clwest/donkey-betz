...
|---|---|---|
| **`docs/audit/`** | **CURRENT.** Active audit + cleanup plan. | [`AUDIT_V1.md`](audit/AUDIT_V1.md) · [`CLEANUP_PLAN.md`](audit/CLEANUP_PLAN.md) · [`README.md`](audit/README.md) · [`SESSION_1143_DOCS_AUDIT.md`](audit/SESSION_1143_DOCS_AUDIT.md) (corpus audit) · [`SESSION_1143_ABANDONED_FEATURES_AUDIT.md`](audit/SESSION_1143_ABANDONED_FEATURES_AUDIT.md) (abandoned-features audit) · [`SESSION_1143_REDUNDANCY_HUNT.md`](audit/SESSION_1143_REDUNDANCY_HUNT.md) (Phase 4 redundancy hunt) |
