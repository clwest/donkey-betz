...
**Last Updated:** Session 1142 (May 24, 2026 — PA tool counts refreshed to 105 schemas / 170 handlers; original Session 969b narrative below)
...
**Headline:** 83 agents in AGENT_MAP (74 enabled, 8 rerouted, 1 blocked); 89 rows in Agent table.

**Notes:** AGENT_MAP total = 83 (74 enabled + 8 rerouted + 1 blocked). DB Agent rows = 89. Top agent_type breakdown: core=65, creative=8, tool_direct=5, content=3, research=2, analytics=2, clean_architecture=2, engineering=1, automation=1. Blocked: ['CodeGeneratorAgent']. Rerouted: ['AudioAgent', 'COOAgent', 'CTOAgent', 'CodeReviewAgent', 'DevOpsAgent', 'FullStackDeveloperAgent', 'VideoAgent', 'WorkflowAgent'].

_Auto-generated by `refresh_doc_inventory_blocks`. Do not hand-edit between markers._
<!-- @inventory-block:end -->

<!-- @inventory-block:pa-summary -->
**Headline:** 109 tool schemas + 152 registered handlers; 8 enrichment services

**Notes:** Schemas: 109. Handlers (self.register in tool_dispatcher.py): 152. Intent-mapped: 106. Unique enrichment services (8): ['advisor', 'blog_performance', 'domain_context', 'intelligence_enricher', 'platform_briefing', 'proactive_intelligence', 'spider_trends', 'strategic_memory'].
...
> Source of truth: `docs/PLATFORM_INVENTORY.md`. PA tool count refreshed Session 1142: **105 schemas / 170 handlers**.
