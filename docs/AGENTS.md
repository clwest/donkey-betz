...
**Headline:** 83 agents in AGENT_MAP (73 enabled, 9 rerouted, 1 blocked); DB Agent rows are tracked separately.
...
**Total Agents: 83 in AGENT_MAP** (73 enabled, 9 rerouted, 1 blocked) | **DB persona rows tracked separately** | **Workspace-Aware: 20** | **User-Context-Enhanced: 4** | **Provenance-Tracked: 29+**
