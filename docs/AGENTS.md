...
**Total Agents: 83 in AGENT_MAP** (73 enabled, 8 rerouted, 2 blocked) | **+ 223 DB persona-eligible Agent rows = 306 total** | **Workspace-Aware: 20** | **User-Context-Enhanced: 4** | **Provenance-Tracked: 29+**
