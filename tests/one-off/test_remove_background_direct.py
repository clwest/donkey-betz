#!/usr/bin/env python3
"""
Test background removal directly - Session 131 diagnostic
"""
...
print("=" * 80)
print("BACKGROUND REMOVAL DIRECT TEST - Session 131")
print("=" * 80)
...
# Test 1: Direct agent call with UUID
print(f"\n🧪 TEST 1: Direct agent call with UUID")
print("=" * 80)

agent = ImageEditingAgent(user=user, project_id=None)
result = agent.execute(operation='remove_background', image_id=str(test_image.id))
