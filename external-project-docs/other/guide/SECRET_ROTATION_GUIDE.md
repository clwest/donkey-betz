...
- [ ] **Groq API Key**: `gsk_ElbSphWQGLZAo9d5wiA2...` → [Rotate at Groq Console](https://console.groq.com/)
- [ ] **Gemini API Key**: `AIzaSyBzdQL_-aBwI0S5CRIo...` → [Rotate at Google AI Studio](https://aistudio.google.com/)
...
- [ ] **Polygon API Key**: `bpHUT4KfOxdoXNYEGa43...` → [Rotate at Polygon.io](https://polygon.io/dashboard/api-keys)
...
#### Social Media APIs
- [ ] **Reddit Client ID/Secret**: `aO5dsNhCDKXnH0is8IXL1g` → [Rotate at Reddit Apps](https://www.reddit.com/prefs/apps)
